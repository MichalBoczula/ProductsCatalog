...
namespace ProductCatalog.Performance.BenchmarkTests.MobilePhones.Application.Common
{
    internal static class MobilePhonesApplicationBenchmarkDataFactory
    {
        ...
        {
            return new GetMobilePhoneByIdQuery(id);
        }

        public static GetMobilePhoneByIdsQuery CreateByIdsQuery(IReadOnlyCollection<Guid> ids)
        {
            return new GetMobilePhoneByIdsQuery(ids);
        }
        ...
        public static IReadOnlyList<MobilePhoneReadModel> CreateReadModels()
        {
